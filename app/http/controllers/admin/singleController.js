...
class singleController extends Controller {
    async index(req, res,next) {
        try {
            ...
            let single = await Single.paginate({},{page,limit:5,sort:{createdAt:-1}, populate : 'parent'});
    ...
    async editSingle(req,res,next){
        try {
            ...
            let {body,slug,title} = req.body;
            
            await Single.findByIdAndUpdate(req.params.id,{$set:{
                body,title,slug
                ,...objUpdate}})           
